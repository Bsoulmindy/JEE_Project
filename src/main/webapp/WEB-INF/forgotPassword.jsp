...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="chat-client-vendeur.css">
    ...
    <style>
      ...
      .texte_centrer {
        ...
        box-shadow: 15px 9px 3px rgb(105, 108, 121);
        position: absolute;
        top: 50%;
        left: 50%;
        ...
        height: 35%;
        text-align: justify;
        border-color: rgb(118, 115, 134);
      }
      .child{
        color: rgb(96, 100, 168);
        text-shadow: 2px 3px;
      }
      </style>
  ...
  <body   class="u-body u-overlap u-overlap-contrast u-stick-footer"><header class="u-black u-clearfix u-header" id="sec-8099"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <!-- <div class="contenu"><img style=" width: 100vw; height: 100vh; margin: auto;" src="images/pexelsphoto218863.jpeg" alt="">
  <span style="background-color: white; width: 10vw; height: 20px; margin: auto; margin-top: 160px;">
        
    </span> </div>   -->
    <!-- <img src="images/pexelsphoto218863.jpeg" alt="commentaire" usemap="#nom-de-la-carte" width="1000" height="950" name="nom-de-l-image" /> -->
    <!-- <span style="background-color: rgb(187, 40, 40); width: 10vw; height: 20vh; margin: auto; margin-left: auto; margin-top: 160px;"></span> -->

    <div class="contenant">
      <img src="images/pexelsphoto218863.jpeg" alt="image">
      <div class="texte_centrer">
        <h1 class="child">Reinitialisation du mot de passe</h1>
        <p style="margin-bottom: 30px; margin-top: 44px;">Mot de passe oublié? Aucun problème. Communiquez-nous simplement votre adresse e-mail et nous vous enverrons par e-mail un lien de reinitialisation de mot de passe qui vous permettra d'en choisir un nouveau.</p>
        <label style="color: rgb(53, 20, 172);" for="email"><strong>Email:</strong></label><br>
        <input style="box-shadow: 1px 1px rgb(167, 195, 204); width: 500px; margin-left: 100px; border: 2px solid rgb(125, 156, 161); border-radius:12;" type="email" name="email" id="" required><br>
        <input style="border-radius: 11px; height: 55px; margin-top: 30px; margin-left: 300px; color: white; background-color: rgb(85, 63, 163);" type="submit" value="envoyer un lien de reinitialisation">
      </div>
    </div>
