          ...
          <div class="u-container-layout u-valign-top u-container-layout-1">
            ...
            <div class="d-flex flex-row justify-content-center my-2">
              <div class="alert alert-success" role="alert">
                Un mail a été envoyé! Veuillez verifier votre boîte mail.
              </div>
            </div>
            </c:if>
            <div class="d-flex flex-row justify-content-center my-2">
              <p class="fs-5">Mot de passe oublié? Aucun problème. Communiquez-nous simplement votre adresse e-mail et nous vous enverrons par e-mail un lien de reinitialisation de mot de passe qui vous permettra d'en choisir un nouveau.</p>
            </div>
            <div class="u-form u-form-1">
              <form action="/forgot_password" method="POST" class="u-clearfix u-form-spacing-13 u-inner-form" style="padding: 0;" name="form">
